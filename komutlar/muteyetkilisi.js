...
`)
  ...
  message.channel.send(`${client.emojis.get("647746144155467786")} ${rol} Rolü Olan Her Kullanıcı İnsanları !mute Komutu İle Susturabilecektir Rolü Verirken Dikkatli Olunuz.`)
